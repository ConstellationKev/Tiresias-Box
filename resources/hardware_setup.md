...
These hardware steps are assuming you have everything that the BOM requires. Also refer to the [BOM](Tiresias-Box/BOM/BOM.csv) which will contain everything you will need to assemble this project.
